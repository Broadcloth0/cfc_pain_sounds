...

{
    ...
    "models/player/soldier_stripped.mdl": combineSounds

    "models/player/zombie_classic.mdl": zombieSounds
    "models/player/zombie_fast.mdl": zombieSounds
    "models/player/charple.mdl": zombieSounds
    "models/player/corpse1.mdl": zombieSounds
    "models/player/zombie_soldier.mdl": zombieSounds
    "models/player/skeleton.mdl": zombieSounds
